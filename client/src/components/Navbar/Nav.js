...
import {
  NavbarContainer, NavLogo, Wrapper, MobileIcon, NavMenu, NavItem, NavLinkR, NavBtn, NavBtnModal, NavBtnLinkR
} from './NavbarElements'
import { FaBars, FaTimes } from 'react-icons/fa'
import { useSelector } from 'react-redux'
import { animateScroll as scroll } from 'react-scroll'
import { auth, logout } from '../../reduxStore/_actions/user_actions'
    ...
    <>
      <Wrapper>
        <NavbarContainer>
          ...
          <NavMenu>
            <NavItem>
              <NavLinkR {...props.smoothBox} to='/about'>About</NavLinkR>
            </NavItem>
            <NavItem>
